...
namespace LibreriaSimulacion
{
    class ExcelAPI
    {
        ...
        public void exportarTablaExponencial(Fila[] tabla, double mediaObservada, double desvObservada, int cantNum, int lambda, int intervalos)
        {
            try
            {
        ...
        public double ProbDistrExpo(int lambda, double limSup, double limInf)
        {
            double resultado;
